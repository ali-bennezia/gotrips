...
@Component({
  selector: 'app-flight-reservation-details-page',
  templateUrl: './flight-reservation-details-page.component.html',
  styleUrls: ['./flight-reservation-details-page.component.css'],
})
export class FlightReservationDetailsPageComponent
  implements OnInit, OnDestroy
{
  errorDisplay: string = '';
  loading: boolean = false;
  id: number | null = null;
  data: FlightReservationDetailsDto | null = null;
  ...
  fetchData() {
    ...
    this.subscription = this.http
      .get<FlightReservationDetailsDto>(
        `${environment.backendUrl}/api/flight/reservations/get/${this.id}`,
        {
          headers: {
